  ...
  return (
    <div className="w-full h-auto">
      <div className="w-full flex justify-between items-center">
        ...
        >
          <li
            className="hidden max-[375px]:block font-['Roboto'] text-[#262A2F] max-[375px]:mt-5 max-[375px]:ml-32"
            onClick={() => {
              setShow(false);
            }}
          >
          ...
          <li className="mx-5 py-2 px-6 font-['Roboto'] bg-[#F2707C] text-[#ffffff] rounded-sm max-[375px]:my-2">
            Get Started
          </li>
        </ul>
      </div>
