...
const Rewards = () => {
  ...
  return (
    <div className="w-full flex h-[608px] bg-[#FFE4E7] max-[375px]:flex max-[375px]:flex-col max-[375px]:bg-[#fff] font-['Roboto']">
      <div className="w-[47%]">
        <div className="flex flex-col items-start w-[587px] max-[375px]:w-[327px] max-[375px]:text-[16px] pl-[108px] pt-[136px] max-[375px]:p-0">
          ...
          <div className="pl-[10px]  max-[375px]:px-[24px] ">
            ...
            <p className="pt-[16px] text-[24px] max-[375px]:p-0 max-[375px]:pt-[16px] max-[375px]:text-[16px] font-normal font-['Questrial']">
          ...
          <div className="flex pl-[24px] pt-[16px] items-center">
            <p className="min-[1440px]:hidden text-[16px] font-medium font=['Helvetica Neue']  underline">
              Get Started
            </p>
            <div className="ml-3">
      ...
      <div className="w-[36%] max-[375px]:hidden relative ml-[9px] flex justify-center items-center">
        <Carousel />
      </div>
    </div>
  );
